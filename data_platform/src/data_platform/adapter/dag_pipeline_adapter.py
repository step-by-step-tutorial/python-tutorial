...
class DagPipelineAdapter:
    ...
    def cleaning(self, raw_relative_path: str) -> str:
        return self._pipeline.store_cleaned_data(self._pipeline.cleaning(raw_relative_path))

    def enriching(self, cleaned_relative_path: str) -> str:
        return self._pipeline.store_enriched_data(self._pipeline.enriching(cleaned_relative_path))
