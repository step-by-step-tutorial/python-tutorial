...
def initialize_registries() -> None:
    ...
    endpoint_registry.register(Key.SALE_CSV_FILE, FileEndpoint(
    ...
    endpoint_registry.register(Key.SALE_REST_API, RestApiEndpoint(
                name=Key.SALE_REST_API,
                url=f"{main_settings.api['test_data'].url.rstrip('/')}/datasets/sale.json/download?format=json",
            ))
    endpoint_registry.register(Key.SALE_KAFKA_CONSUMER, MessagingEndpoint(
    ...
    endpoint_registry.register(Key.SALE_KAFKA_PRODUCER, MessagingEndpoint(
    ...
    endpoint_registry.register(Key.SALE_DATA_LAKE, DataLakeEndpoint(
    ...
    endpoint_registry.register(Key.SALE_DATABASE, DatabaseEndpoint(
    ...
    endpoint_registry.register(Key.SALE_WAREHOUSE, WarehouseEndpoint(
    ...
    endpoint_registry.register(Key.HOUSE_CSV_FILE, FileEndpoint(
    ...
    endpoint_registry.register(Key.HOUSE_KAFKA_CONSUMER, MessagingEndpoint(
    ...
    endpoint_registry.register(Key.HOUSE_KAFKA_PRODUCER, MessagingEndpoint(
    ...
    endpoint_registry.register(Key.HOUSE_DATA_LAKE, DataLakeEndpoint(
    ...
    endpoint_registry.register(Key.HOUSE_DATABASE, DatabaseEndpoint(
    ...
    endpoint_registry.register(Key.HOUSE_WAREHOUSE, WarehouseEndpoint(
    ...
    endpoint_registry.register(Key.ONLINE_SHOPPING_REST_API, RestApiEndpoint(
    ...
    endpoint_registry.register(Key.ONLINE_SHOPPING_DATA_LAKE, DataLakeEndpoint(
    ...
    endpoint_registry.register(Key.ONLINE_SHOPPING_DATABASE, DatabaseEndpoint(
    ...
    endpoint_registry.register(Key.ONLINE_SHOPPING_WAREHOUSE, WarehouseEndpoint(
