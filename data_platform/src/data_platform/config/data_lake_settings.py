...
from data_platform.util.path_utils import generate_checkpoint_path
...
data_lake = MappingProxyType(
    {
        Key.PLATFORM_DATA_LAKE: DataLakeSettings(
            ...
            bucket_name=os.getenv("DATA_PLATFORM_DATALAKE_BUCKET_NAME", "online-shopping"),
            audit_bucket_name=os.getenv("DATA_PLATFORM_DATALAKE_AUDIT_BUCKET_NAME", "audit"),
            ...
            checkpoint_path=os.getenv("DATA_PLATFORM_DATALAKE_CHECKPOINT_PATH",
                                      generate_checkpoint_path("online-shopping", "events")),
        ),
        Key.PLATFORM_BACKUP_DATA_LAKE: DataLakeSettings(
            endpoint=os.getenv("DATA_PLATFORM_DATALAKE_ENDPOINT", "http://localhost:9000"),
            access_key=os.getenv("DATA_PLATFORM_DATALAKE_ACCESS_KEY", "admin"),
            secret_key=os.getenv("DATA_PLATFORM_DATALAKE_SECRET_KEY", "administrator"),
            bucket_name=os.getenv("DATA_PLATFORM_DATALAKE_BACKUP_BUCKET_NAME", "backup"),
            audit_bucket_name=os.getenv("DATA_PLATFORM_DATALAKE_AUDIT_BUCKET_NAME", "audit"),
            scheme=os.getenv("DATA_PLATFORM_DATALAKE_SCHEME", "s3a"),
            environment=os.getenv("DATA_PLATFORM_DATALAKE_ENVIRONMENT", "dev"),
            checkpoint_path=os.getenv("DATA_PLATFORM_DATALAKE_CHECKPOINT_PATH",
                                      generate_checkpoint_path("backup", "events")),
        ),
        Key.HOUSE_DATA_LAKE: DataLakeSettings(
            ...
            audit_bucket_name=os.getenv("DATA_PLATFORM_HOUSE_DATALAKE_AUDIT_BUCKET_NAME", "audit"),
            ...
            checkpoint_path=os.getenv("DATA_PLATFORM_HOUSE_DATALAKE_CHECKPOINT_PATH",
                                      generate_checkpoint_path("house", "house.events.v1")),
        ),
        Key.HOUSE_BACKUP_DATA_LAKE: DataLakeSettings(
            ...
            environment=os.getenv("DATA_PLATFORM_HOUSE_DATALAKE_ENVIRONMENT", "dev"),
            checkpoint_path=os.getenv("DATA_PLATFORM_HOUSE_DATALAKE_CHECKPOINT_PATH",
                                      generate_checkpoint_path("backup", "house.events.v1")),
        ),
        Key.AUDIT_DATA_LAKE: DataLakeSettings(
            ...
            bucket_name=os.getenv("DATA_PLATFORM_AUDIT_DATALAKE_BUCKET_NAME", "audit"),
            audit_bucket_name=os.getenv("DATA_PLATFORM_AUDIT_BUCKET_NAME", "audit"),
            ...
            checkpoint_path=os.getenv("DATA_PLATFORM_AUDIT_DATALAKE_CHECKPOINT_PATH",
                                      generate_checkpoint_path("audit", "audit.events.v1")),
        ),
    }
)
