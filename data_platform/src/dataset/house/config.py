...
HOUSE_DATASET = Dataset(
    ...
    endpoints={
        ...
        "house.rest": RestApiEndpoint(
            name="house.rest",
            url=main_settings.rest["house.rest"].url,
            method=main_settings.rest["house.rest"].method,
        ),
        "house.kafka.listener": MessagingEndpoint(
            name="house.kafka.listener",
            connection_name="house.kafka.listener",
            channel_name=main_settings.messaging["house.kafka.listener"].channel_name,
            bootstrap_servers=main_settings.messaging["house.kafka.listener"].bootstrap_servers,
            starting_offsets=main_settings.messaging["house.kafka.listener"].starting_offsets,
        ),
