...
def create_session() -> SparkSession:
    ...
    session = (
        ...
        .config("spark.hadoop.fs.s3a.endpoint", main_settings.datalake[Key.DATA_PLATFORM_DATALAKE].endpoint)
        .config("spark.hadoop.fs.s3a.access.key", main_settings.datalake[Key.DATA_PLATFORM_DATALAKE].access_key)
        .config("spark.hadoop.fs.s3a.secret.key", main_settings.datalake[Key.DATA_PLATFORM_DATALAKE].secret_key)
