...
from audit.audit_event_converter import to_audit_pipeline_model, to_audit_task_model
...
PIPELINE_STARTED_SQL = read_text_file("insert_audit_pipeline_started.sql")
PIPELINE_FINISHED_SQL = read_text_file("update_audit_pipeline_finished.sql")
TASK_STARTED_SQL = read_text_file("insert_audit_task_started.sql")
TASK_FINISHED_SQL = read_text_file("update_audit_task_finished.sql")
