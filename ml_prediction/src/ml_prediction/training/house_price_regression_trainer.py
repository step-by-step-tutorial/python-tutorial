...
class HousePriceRegressionTrainer(Trainer[Experiment]):
    ...
    def _train(self) -> Experiment:
        ...
        experiment_id = self._experiment_service.start(self._settings.model_parameters.as_dict())
        ...
        self._experiment_service.record(TargetExtracted(len(features_and_target.target), self._settings.target_column))
        ...
        self._experiment_service.log_metrics("validation", validation_metrics)
        ...
        self._experiment_service.log_metrics("test", final_test_evaluation.metrics)
        self._experiment_service.record(ModelEvaluated(
            "test",
            len(partitions.test.features),
            self._settings.model_type,
        ...
        self._experiment_service.log_model(trained_model.pipeline)
        ...
        result = Experiment(
            ...
            report_path=self._experiment_service.report_path,
